...
export const ICONS = {
  ...
  // OTT Platforms
  series_toggle_icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1.5 inline-block"><path stroke-linecap="round" stroke-linejoin="round" d="M6 20.25h12m-7.5-3.75V3.75m3.75 0v16.5M5.25 4.5h13.5A2.25 2.25 0 0 1 21 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25H5.25a2.25 2.25 0 0 1-2.25-2.25V6.75a2.25 2.25 0 0 1 2.25-2.25Z" /></svg>`, // Renamed from netflix
  ...
  question_frequency: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 text-purple-400"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>`,
  ...
  question_language: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 text-purple-400"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 21M10.5 18v3m0 0c2.227-.303 3.955-.787 5.413-1.41M10.5 21H3.75a2.25 2.25 0 0 1-2.25-2.25v-1.5c0-1.06.396-2.045 1.078-2.828M10.5 21V3.75a2.25 2.25 0 0 1 2.25-2.25h1.5A2.25 2.25 0 0 1 16.5 3.75v.278m-6 17.222 8.172-8.172a4.5 4.5 0 0 0-6.364-6.364L10.5 6.75M10.5 18l-2.5-2.5m0 0l2.5-2.5m-2.5 2.5h5m-5-2.5V3.75m0 3.75H3.75" /></svg>`,
  ...
  discovery_tab_icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25H5.25a2.25 2.25 0 0 1-2.25-2.25V8.625c0-.621.504-1.125 1.125-1.125H7.5M12 15V7.5" /></svg>`,
  ...
  taste_check_tab_icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 4.129 2.134 7.643 5.176 9.817M12.53 18.462A9.004 9.004 0 0 1 12 21a9 9 0 0 1-7.054-14.078M15.75 19.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM15.75 14.25a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.01a.75.75 0 0 1-.75-.75V14.25Zm-3.375 0a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.01a.75.75 0 0 1-.75-.75V14.25Zm-3.375 0a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.01a.75.75 0 0 1-.75-.75V14.25Z" /></svg>`,
