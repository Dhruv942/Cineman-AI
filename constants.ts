...
export const ICONS = {
  ...
  adventure: `<img src="./icons/hiking.png" alt="Adventure genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  animation: `<img src="./icons/animation.png" alt="Animation genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  drama: ` <img src="./icons/theater.png" alt="Drama genre" class="w-4 h-4 mr-1.5 inline-block"/>`,
  documentary: `<img src="./icons/documentary.png" alt="Documentary genre" class="w-4 h-4 mr-1.5 inline-block"/>`,
  ...
  scifi: `<img src="./icons/rocket.png" alt="Sci-fi genre" class="w-4 h-4 mr-1.5 inline-block"/>`,
  thriller: `<img src="./icons/searcher.png" alt="Thriller genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  horror: `<img src="./icons/hand.png" alt="Horror genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  history: `<img src="./icons/scroll.png" alt="History genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  crime: `<img src="./icons/knife.png" alt="Crime genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  sport: `<img src="./icons/running.png" alt="Sport genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  superhero: `<img src="./icons/action.png" alt="Superhero genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  family: `<img src="./icons/family.png" alt="Family genre" class="w-4 h-6 mr-1.5 inline-block"/>`,
  fantasy: `<img src="./icons/wand.png" alt="Fantasy genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  music: `<img src="./icons/musical-note.png" alt="Music genre" class="w-4 h-4 mr-1.5 inline-block"/>`,
  musical: `<img src="./icons/music.png" alt="Musical genre" class="w-4 h-4 mr-1.5 inline-block"/>`,
  mystery: `<img src="./icons/annonymous.png" alt="Mystery genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  war: `<img src="./icons/tank.png" alt="War genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  western: `<img src="./icons/cowboy.png" alt="Western genre" class="w-6 h-6 mr-1.5 inline-block"/>`,
  facebook: `<img src = './icons/Facebook.png' alt="Share on Facebook" class="w-10 h-10 mr-1.5 inline-block"/>`,
  whatsapp: `<img src = './icons/WhatsApp.png' alt="Share on WhatsApp" class="w-10 h-10 mr-1.5 inline-block"/>`,
  twitter: `<img src = './icons/twitter.jpg' alt="Share on Twitter" class="w-10 h-10 mr-1.5 inline-block"/>`,
  ...
  // OTT Platforms
  series_toggle_icon: `<img src="./icons/episodes.png" alt="TV series" class="w-6 h-6 mb-4 mt-[-0.5 rem] rounded-full inline-block"/>`, // Renamed from netflix
  ...
  question_frequency: `<img src="./icons/repeat.png" alt="Frequency" class="w-6 h-6 mr-2 text-purple-400 inline-block"/>`,
  ...
  question_language: `<img src="./icons/language.png" alt="Language" class="w-6 h-6 mr-2 text-purple-400 inline-block"/>`,
  ...
  question_seasons: `<img src="./icons/episodes.png" alt="Seasons" class="w-6 h-6 mr-2 text-purple-400 inline-block"/>`,
  ...
  discovery_tab_icon: `<img src="./icons/compass.png" alt="Discovery" class="w-6  h-4 mb-2 mr-1.5 inline-block"/>`,
  watch_party_tab_icon: `<img src="./icons/cinema.png" alt="Watchlist" class="w-4 h-4 mb-2 mr-1.5 inline-block"/>`,
  taste_check_tab_icon: `<img src="./icons/like.png" alt="Taste check" class="w-4 h-4 mb-2 mr-1.5 inline-block"/>`,
